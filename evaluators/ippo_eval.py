...
class IPPOEvaluator:
    ...
    def find_red_actions(self, red_actions, agent_name):
        ...
        red_agent = f'red_agent_{int(number[0])+add}'
            ...
            for j in range(self.EPISODE_LENGTH):  # Episode length
                ...
                for agent in active_agents:
                    ...
                    if 'green_agent' in agent:
                        ...
                        if 'restricted_zone_a' in hostname or 'operational_zone_a' in hostname:
                            green_actions['blue_agent_0'].append({'act':green_action, 'hostname': hostname})
                        elif 'restricted_zone_b' in hostname or 'operational_zone_b' in hostname:
