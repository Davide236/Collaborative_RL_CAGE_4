...
averages4 = calculate_averages(data4)
# Plot the average reward per episode for both files
plt.figure(figsize=(10, 5))
plt.subplot(2, 1, 1)
plt.plot(averages1, label='NGU Constant', color='blue')
plt.plot(averages2, label='IPPO Basic', color='orange')
plt.plot(averages3, label='NGU Annealed', color='green')
...
plt.subplot(2, 1, 2)
plt.plot(rolling_averages1, label='NGU Constant', color='blue')
plt.plot(rolling_averages2, label='IPPO Basic', color='orange')
plt.plot(rolling_averages3, label='NGU Annealed', color='green')
