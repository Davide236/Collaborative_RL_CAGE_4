...
plt.subplot(2, 1, 1)
plt.plot(averages1, label='MAPPO New State', color='blue')
plt.plot(averages2, label='MAPPO Old State', color='orange')
...
plt.subplot(2, 1, 2)
plt.plot(rolling_averages1, label='MAPPO New State', color='blue')
plt.plot(rolling_averages2, label='MAPPO Old State', color='orange')
