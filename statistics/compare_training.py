...
plt.subplot(2, 1, 1)
plt.plot(averages1, label='Baseline PPO', color='blue')
plt.plot(averages2, label='2 Bits Message PPO', color='orange')
plt.plot(averages3, label='Centralized PPO', color='green')
...
plt.subplot(2, 1, 2)
plt.plot(rolling_averages1, label='Baseline PPO (50 episodes)', color='blue')
plt.plot(rolling_averages2, label='Message PPO (50 episodes)', color='orange')
plt.plot(rolling_averages3, label='Centralized PPO (50 episodes)', color='green')
