...
class AgentNetwork(nn.Module):
    def __init__(self, input_dim, output_dim, fc):
        ...
        self.fc1 = nn.Linear(input_dim, self.layed_dim)  # First layer
        self.fc2 = nn.Linear(self.layed_dim, self.layed_dim)  # Second layer
        self.fc3 = nn.Linear(self.layed_dim, output_dim)  # Output layer
